...
public void OnPluginStart() 
{
    ...
    cvAnnShowRange = CreateConVar("sm_cvann_show_range", "0", "Show Distance to speaker in Annotations. (1 = Enable, 0 = Disable)", FCVAR_NONE, true, 0.0, true, 1.0);
    ...
    cvAnnShowCmd   = CreateConVar("sm_cvann_show_cmd", "1", "Command Visibility. (0 = Hide ! and /, 1 = Show !, 2 = Show /, 3 = Show ! and /)", FCVAR_NONE, true, 0.0, true, 3.0);
...
{
    if (condition == TFCond_Cloaked || condition == TFCond_Disguised || condition == TFCond_Disguising)
    {
...
void MeowMeow(int client, bool isTeam, const char[] msg, float life)
{
    ...
    strcopy(g_cLastMsg[client], sizeof(g_cLastMsg[]), msg);
